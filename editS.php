...
<?php
								...
								{
								$ad_id=$_GET['id'];
								$result=mysqli_query($connect,"SELECT * FROM slideshow WHERE SlideID='$ad_id'");
...
if(isset($_POST["sbtn"]))
{
	...
	if(empty($product_image)){
		...
		header("refresh:0.001;url=editS.php?details&id=$SID");

	}else{

$sql=mysqli_query($connect,"Update slideshow SET SImage = '$product_image'
												   WHERE SlideID = '$ad_id'");
                        ...
                        <div class="col-12">
							...
							<div class="form-group" style="text-align:center;">
								...
								<hr>
									...
									<img class="" style="margin:auto;width:150px;height:auto%;border-radius:30px;" img src="images/<?php echo $row['SImage'] ?>" type="image" class="form-control selectList"  autocomplete="off"  list="code" onchange="showCustomer(this.value)" style="width:100%;Height:50%;" name="" id="gender" readonly>
									</div>
									</div>				
